        ...
        title: Row(
          ...
          children: [
            ...
            BlocBuilder<HomeBloc, HomeState>(
                buildWhen: (_, current) => current is HomeLoadingState || current is HomeLoadedState,
                builder: (context, state) {
              return state is HomeLoadedState ? GestureDetector(
                  onTap: () => locator.get<NavigationService>().navigateTo(ScreenName.profile, arguments: GlobalDatabaseHelper.currentUser),
                  child: CommonWidget.getProfileIcon(GlobalDatabaseHelper.currentUser?.userName)) : Container();
            }),
          ],
        ),
      ),
        ...
        listener: (context, state) {
          if (state is HomeLoadedState) {
            bloc.continueReadingSubscription = locator
                ...
                .getContinueReadingNovelsRef(
                  GlobalDatabaseHelper.currentUser!.userId!,
                )
                .onValue
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        BlocBuilder<HomeBloc, HomeState>(
                          builder: (context, state) {
                            return bloc.continueReadingNovels.isNotEmpty
                                ? Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemCount:
                                            bloc.continueReadingNovels.length,
                                                    ...
                                                    children: [
                                                      Positioned(
                                                        ...
                                                        child: GestureDetector(
                                                          onTap:
                                                              () => CommonWidget.showBottomModalSheet(
                                                                context:
                                                                    context,
                                                                title:
                                                                    bloc.continueReadingNovels
                                                                  ...
                                                                  BottomSheetModalItem(
                                                                    ...
                                                                    onTap: () {
                                                                      locator
                                                                          ...
                                                                          >()
                                                                          .goBack();
                                                                      GlobalDatabaseHelper.removeNovelFromContinueReading(
                                                                        bloc.continueReadingNovels
                                                                            .elementAt(
                                                                              index,
                                                                            )
                              ...
                              GestureDetector(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    component.category == AppStrings.topPicks
                                        ? const SizedBox()
                                        : const Icon(
